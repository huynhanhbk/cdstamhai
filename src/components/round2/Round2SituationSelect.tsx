  ...
  return (
    <div className="relative min-h-[calc(100vh-68px)] p-6 md:p-8 lg:p-12 flex flex-col justify-between bg-slate-950">
      ...
      <div className="relative z-10 max-w-full mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-slate-800">
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-3 rounded-2xl bg-slate-900 border border-slate-700 text-slate-300 hover:text-white hover:border-indigo-500/50 hover:bg-slate-850 transition"
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="px-4 md:px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:to-pink-500 text-white font-black text-xs md:text-sm flex items-center gap-2 shadow-lg shadow-indigo-950/60 hover:scale-105 active:scale-95 transition"
              ...
              <button
                ...
                className={`relative group rounded-3xl p-5 md:p-6 flex flex-col items-center justify-center text-center transition-all duration-200 border-2 active:scale-95 ${
                  isCompleted
                    ...
                    : 'bg-slate-900/90 border-indigo-500/40 hover:border-indigo-300 hover:bg-slate-850 shadow-xl shadow-indigo-950/30 hover:scale-105'
                }`}
              >
                {/* Number Badge */}
                <div
                ...
                <div className="mt-1">
                  {isCompleted ? (
                    ...
                    <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-indigo-950/70 border border-indigo-500/40 text-indigo-300 text-xs font-semibold group-hover:bg-indigo-600 group-hover:text-white transition">
      ...
      <RandomDrawModal
        ...
        subtitle="Phần thi 2: Xử lý tình huống"
        items={drawItems}
        themeColor="indigo"

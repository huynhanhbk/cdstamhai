...
export const Round2RulesModal: React.FC<Round2RulesModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-slate-900 border border-indigo-500/40 rounded-3xl shadow-2xl p-6 md:p-8 text-slate-100 max-h-[90vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-6">
          <div className="inline-block px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-bold uppercase tracking-wider mb-2">
            THỂ LỆ CHÍNH THỨC
          </div>
          <h2 className="text-2xl md:text-3xl font-black text-white">
            PHẦN THI 2: XỬ LÝ TÌNH HUỐNG
          </h2>
          <p className="text-indigo-400 font-bold text-lg mt-1">“CÔNG DÂN SỐ THÔNG THÁI”</p>
        </div>
        ...
        <div className="space-y-6 text-slate-200">
          ...
          <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 space-y-3">
            ...
            <div className="text-sm space-y-2 text-slate-300">
              <p>Điểm tối đa: <strong className="text-emerald-400 text-base">30 ĐIỂM</strong>.</p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-2 text-xs">
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-700">
                  <div className="font-semibold text-slate-200">Vượt dưới 02 phút</div>
                  <div className="text-rose-400 font-bold mt-1">-02 điểm</div>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-700">
                  <div className="font-semibold text-slate-200">Vượt 03 đến 05 phút</div>
                  <div className="text-rose-400 font-bold mt-1">-05 điểm</div>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-700">
                  <div className="font-semibold text-slate-200">Vượt trên 05 phút</div>
                  <div className="text-rose-400 font-bold mt-1">-10 điểm</div>
                </div>
              </div>
        ...
        <div className="mt-8 text-center">
          <button
            onClick={onClose}
            className="w-full py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-base transition shadow-lg shadow-indigo-950/50"
          >
            Đã Rõ Thể Lệ
          </button>
        </div>

...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="relative min-h-[calc(100vh-68px)] flex flex-col justify-between p-4 md:p-8 lg:p-12 overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-2 md:pt-6">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-950/60 border border-cyan-500/40 text-cyan-300 text-xs md:text-sm font-semibold tracking-wider uppercase mb-4 shadow-lg shadow-cyan-950/30">
          <Sparkles className="w-4 h-4 text-cyan-400" />
          <span>{settings.organizer}</span>
        </div>

        <div className="text-xl md:text-2xl lg:text-3xl font-bold tracking-widest text-amber-300 uppercase mb-2 drop-shadow-md">
          HỘI THI
        </div>

        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-white leading-tight uppercase drop-shadow-2xl">
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 my-8">
        ...
        <div className="group relative rounded-3xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border-2 border-cyan-500/30 hover:border-cyan-400 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/20 p-6 md:p-8 flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="text-lg sm:text-xl font-bold text-cyan-300 mt-1 mb-4">
              “AI HIỂU BIẾT SỐ HƠN”
            </div>

            <div className="space-y-2.5 my-6 text-sm text-slate-300">
          ...
          <div className="pt-4 border-t border-slate-800/80 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button
              ...
              className="py-3 px-4 rounded-2xl bg-slate-800 hover:bg-slate-750 text-slate-300 hover:text-white border border-slate-700 font-semibold text-sm flex items-center justify-center gap-1.5 transition"
        ...
        {/* ROUND 2 CARD */}
        <div className="group relative rounded-3xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border-2 border-indigo-500/30 hover:border-indigo-400 transition-all duration-300 shadow-2xl hover:shadow-indigo-500/20 p-6 md:p-8 flex flex-col justify-between">
          <div className="absolute top-4 right-4 flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-800/80 border border-slate-700 text-xs font-semibold text-slate-300">
          ...
          <div>
            ...
            <div className="text-lg sm:text-xl font-bold text-indigo-300 mt-1 mb-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto w-full pt-4 pb-2 border-t border-slate-800/60 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-400">
